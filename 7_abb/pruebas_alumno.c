...
bool contar_datos(const char* clave, void* valor, void* extra){
	size_t* num = extra;
	print_test("Prueba iterador interno, iterando",true);
	if(clave) *num+=1;
	return true;
}
...
void pruebas_iterador_interno(){
	...
	print_test("Prueba iterador interno, inserto primer par",abb_guardar(arbol,claves[0],valores[0]));
	print_test("Prueba iterador interno, inserto segundo par", abb_guardar(arbol,claves[1],valores[1]));
	print_test("Prueba iterador interno, inserto tercer par", abb_guardar(arbol,claves[2],valores[2]));
	print_test("Prueba iterador interno, inserto cuarto par", abb_guardar(arbol,claves[3],valores[3]));
	size_t num=0;
	abb_in_order(arbol,contar_datos,&num);
	print_test("Prueba iterador interno, cantidad iterada correctamente", num==4);
	abb_destruir(arbol);
}
...
void pruebas_volumen_ABB(size_t largo)
{
